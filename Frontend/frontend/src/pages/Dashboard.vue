<template>
  <div>
    ...
    <div
      class="card p-2 px-4 table-row-hover pointer mt-2 mb-4"
      @click="readersStatClick"
    >
      <b-row>
        ...
        <b-col cols="auto" class="pl-0" align-self="center">
          <p class="my-3">{{ $t("dashboard.readersBtn") }}</p>
        </b-col>
    ...
    >
      <b-row>
        ...
        <b-col cols="auto" class="pl-0" align-self="center">
          <p class="my-3">{{ $t("dashboard.personsBtn") }}</p>
        </b-col>
        <b-col align-self="center" class="text-right">
          <i class="ti-angle-right"></i>
        </b-col>
